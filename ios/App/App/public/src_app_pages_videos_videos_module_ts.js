...
let VideosPage = class VideosPage {
    constructor(servicio) {
        ...
        this.videoUri = 'https://theapsu.github.io/videos/miniaturas/';
        this.spanish = [];
        this.english = [];
        this.lang = 'english';
    }
    ngOnInit() {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            const data = (_a = (yield this.servicio.ConsultarVideos())) === null || _a === void 0 ? void 0 : _a.videos;
