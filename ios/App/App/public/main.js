                ...
                paypal.Buttons({
                    ...
                    onApprove: (data, actions) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                        try {
                            ...
                            const res = yield this.httpSv.getExternal(`https://api-m.sandbox.paypal.com/v1/billing/subscriptions/${data.subscriptionID}`, headers);
                            console.log('billing :>> ', res);
                            yield this.httpSv.post('paypal/store-payment', { payer_id: res.subscriber.payer_id });
...
let LoginService = class LoginService {
    constructor(httpSv, navCtrl, uiSv) {
        this.httpSv = httpSv;
        this.navCtrl = navCtrl;
        this.uiSv = uiSv;
    ...
    verifyPaypal(showMsg) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            try {
                ...
                console.error(err);
                if (err.error.msg) {
                    const { role } = yield this.uiSv.showAlert(err.error.msg, 'alert-modal');
                    if (role === 'accept') {
...
let UiService = class UiService {
    ...
    showAlert(message, cssClass = 'alert-modal') {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
